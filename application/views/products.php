					...
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<?php 
								...
								{
									case 'w_spice':
										echo "<h3 class='heading-tittle text-center font-italic'>Spices &amp; Herbs</h3>";
									break;
									
									case 'g_spice':
										echo "<h3 class='heading-tittle text-center font-italic'>Grounded Spices</h3>";
									break;
									
									case 'dry_fruits':
										echo "<h3 class='heading-tittle text-center font-italic'>Dry fruits</h3>";
									break;
									
									case 'grains':
										echo "<h3 class='heading-tittle text-center font-italic'>Grains</h3>";
									break;
									
									default:
										echo "<h3 class='heading-tittle text-center font-italic'>All products</h3>";
								}
							?>
							<div class="row">
							<?php
								...
								{
								?>
									<img src="<?php echo base_url('assets/images/noresult.png'); ?>" style="width:100%;"/>
								<?php
								}
								else
								{
