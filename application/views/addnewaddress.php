			...
			<div class="row">
			  <div class="col-md-12 mb-4">
				<div class="card mb-4">
				  ...
				  <div class="card-body">
					<form action="<?php echo base_url('user/addnewaddress?referer='.$this->input->get('referer')); ?>" method="post">
					  <div class="row mb-4">
					  ...
					  <div class="row mb-4">
						...
						<div class="col">
						  <div class="form-outline">
							<input type="text" name="landmark" id="form6Example2" class="form-control" required/>
